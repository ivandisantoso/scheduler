...
const arrCoursesHtml = allCourses.map(getCourseAsHtmlString);
const strCoursesHtml = arrCoursesHtml.join(`\n`);
document.getElementById(`courses`).innerHTML=strCoursesHtml;
